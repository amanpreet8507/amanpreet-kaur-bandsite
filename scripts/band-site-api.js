...
class BandSiteApi {
    ...
    postComment = async (comment) => {
        const url = 'https://project-1-api.herokuapp.com/comments?api_key=0c1318a1-0c91-4df5-9cfa-b8cbad39d045'
    ...
    getComments = async () => {
        ...
        try{
            ...
            const sortedCommentsArray = finalOutput.sort((a,b) => a.timestamp - b.timestamp)
    ...
    // GetShows object
    getShows = async () => {
        const url = 'https://project-1-api.herokuapp.com/showdates?api_key=0c1318a1-0c91-4df5-9cfa-b8cbad39d045'
        try{
            const response = await axios.get(url)
            const finalOutput = response.data
            return finalOutput
